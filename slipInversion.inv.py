...
model_name='NF-VelMod.mod' #Velocity model
...
rupture_speed=2.5 #Fastest rupture allowed in km/s
num_windows=10 #
reg_spatial=np.logspace(-3,-1,num=20)#Set to False if you don't want to use it
reg_temporal=np.logspace(-4,-1,num=10)#Set to False if don't want to use it
