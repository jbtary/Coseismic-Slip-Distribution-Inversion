...
num_windows=10 #
reg_spatial=np.logspace(-6,0,num=20)#Set to False if you don't want to use it
reg_temporal=np.logspace(-8,2,num=10)#Set to False if don't want to use it
